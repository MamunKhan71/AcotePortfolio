    ...
    return (
        <div>
            <div className="inline-flex items-center justify-center w-full">
                ...
                <span className="absolute px-3 font-medium text-lg md:text-2xl -translate-x-1/2 bg-[#101B26] left-1/2 text-white tracking-[0.7px]">Our Sister Concern</span>
            </div>
                ...
                <div className="flex flex-col md:flex-row items-center gap-4 md:gap-10">
                    ...
                    <div className="flex-1 text-white space-y-10">
                        <div className='space-y-3'>
                            <h3 className="text-2xl md:text-4xl font-semibold text-left">Korean Language Training Center</h3>
                            <p className="text-lg text-[#C1C1C1] md:leading-[28px] text-justify md:text-left">
                        ...
                        <div className="flex items-center justify-start gap-4 md:gap-9 overflow-hidden h-full w-full">
                            ...
                            <div className="flex items-center">
                                ...
                                <div className="ml-5 text-base md:text-xl text-[#878787] inline-flex gap-2 items-center">
